/***********************************************************************************************************
Author: Tolu Adepoju (credit: https://www.sqlservercentral.com/articles/data-profiling-with-t-sql)
Created: 20190521
Description: 
Profiles Data
************************************************************************************************************/
...
USE DataCatalog
GO
IF OBJECT_ID('DataProfile.usp_DataProfiler') IS NOT NULL
	DROP PROCEDURE DataProfile.usp_DataProfiler;
GO
CREATE PROCEDURE DataProfile.usp_DataProfiler
(
	@TABLE_SCHEMA NVARCHAR(128)			        -- Your schema here
,	@TABLE_NAME NVARCHAR(128)           		-- Your table here
,	@ColumnListIN NVARCHAR(4000) = ''           -- Enter a comma-separated list of sprcific columns to profile, or leave blank for all
